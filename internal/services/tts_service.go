...
func NewTTSService(q queue.TaskQueue) *TTSService {
	return &TTSService{
		queue:             q,
		ttsURL:            viper.GetString("tts.url"),
		defaultRefAudio:   viper.GetString("tts.default_ref_audio"),
		defaultTextLang:   viper.GetString("tts.default_text_lang"),
		defaultPromptLang: viper.GetString("tts.default_prompt_lang"),
	}
}
